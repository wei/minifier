...
var cleanResponse = function cleanResponse(originalResponse) {
...
var createCacheKey = function createCacheKey(originalUrl, paramName, paramValue, dontCacheBustUrlsMatching) {
...
var stripIgnoredUrlParameters = function stripIgnoredUrlParameters(originalUrl, ignoreUrlParametersMatching) {
...
self.addEventListener('fetch', function (event) {
  if (event.request.method === 'GET') {
    ...
    var shouldRespond; // First, remove all the ignored parameters and hash fragment, and see if we
